...
const renderGreetingsScreen = () => {
  const greetingsScreen = getElementFromTemplate(greetingsTemplate);
  const button = greetingsScreen.querySelector(`.greeting__continue`);

  button.addEventListener(`click`, renderRulesScreen);
